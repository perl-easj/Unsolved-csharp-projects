...
{
    /// <summary>
    /// Base class for all domain-specific page view models. Is essentially a
    /// CRUD page view model, with a bit of code added for handling proper
    /// display of chosen entry in view state menu.
    /// </summary>
